...
The final answer is $[2,5)$.""",
    ...
    },
    {
        ...
        "solution": """We have that $\\det (\\mathbf{A} \\mathbf{B}) = (\\det \\mathbf{A})(\\det \\mathbf{B}) = 2 \\cdot 12 = 24.$
The final answer is $24$.""",
        "answer": "$24$"
    },
    {
        "problem": "Terrell usually lifts two 20-pound weights 12 times. If he uses two 15-pound weights instead, how many times must Terrell lift them in order to lift the same total weight?",
        "solution": """If Terrell lifts two 20-pound weights 12 times, he lifts a total of 2 * 12 * 20 = 480 pounds of weight.
If he lifts two 15-pound weights instead for n times, he will lift a total of 2 * 15 * n = 30n pounds of weight.
